...
import com.grpc.test.grpcstarterclienttest.interceptor.ClientHeaderInterceptor;
import com.grpc.test.grpcstarterclienttest.interceptor.LogGrpcInterceptor;
    ...
    public GlobalClientInterceptorConfigurerAdapter globalInterceptorConfigurerAdapter() {
        return new GlobalClientInterceptorConfigurerAdapter() {
            ...
            public void addClientInterceptors(GlobalClientInterceptorRegistry registry) {
                ...
                registry.addClientInterceptors(new ClientHeaderInterceptor());
            }
        };
    }
